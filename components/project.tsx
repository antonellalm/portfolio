...
export default function Project({
  ...
  return (
    <section
      ref={ref}
      className="group bg-gray-100 pb-3 max-w-[45rem] border border-black/5 overflow-hidden sm:pr-8 relative sm:h-[21rem] mb-3 sm:mb-8 last:mb-0 hover:bg-gray-200 transition"
    >
